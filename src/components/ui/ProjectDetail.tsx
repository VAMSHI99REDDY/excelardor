            ...
            <div className="flex flex-col lg:flex-row gap-20 lg:gap-32">
              ...
              <div className="w-full lg:w-1/2">
                <div className="lg:sticky lg:top-32 space-y-12">
                  ...
                  <div
                    className={`relative w-full bg-white rounded-3xl overflow-hidden border border-black/5 group flex items-center justify-center cursor-zoom-in ${project.category === "Aerospace and Defence Components" || project.img.includes("DRDOProducts") || /plc operated article loading/i.test(project.img)
                      ? "h-[300px] md:h-[400px]"
              ...
              <div className="flex-1 space-y-20">
                ...
                {project.specs && (
                  <div className="space-y-10">
                    <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-black/30">
                ...
                {project.gallery && (
                  <div className="space-y-10 mt-12">
                    <h4 className="text-xl font-black uppercase tracking-[0.4em] text-black/30">
                      Applications
                    </h4>
                    <div className="grid grid-cols-2 gap-4">
                      {project.gallery.map((src, idx) => (
                        <img
                          key={idx}
                          src={src}
                          alt={`${project.title} application ${idx + 1}`}
                          className="object-contain w-full h-auto rounded-lg cursor-pointer"
                          onClick={() => {
