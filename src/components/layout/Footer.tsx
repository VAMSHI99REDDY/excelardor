        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-20 mb-20">
          ...
          <div className="lg:col-span-5 space-y-6">
            <Link href="/" className="flex items-center gap-3 group">
              <div className="w-12 h-12 sm:w-14 sm:h-14 flex items-center justify-center bg-black/5 rounded-xl border border-black/10 group-hover:border-primary/50 transition-all duration-500">
                <Image
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="text-sm">design.excelardor@gmail.com</span>
              </div>
            </div>
          </div>
        </div>
